...
__C.DATASET.VIDEO_DIR = 'videos'
__C.DATASET.VIDEO_FORMAT = 'avi'
__C.DATASET.TRAIN_SPLIT_NAME = 'video_list_train.txt'
__C.DATASET.TEST_SPLIT_NAME = 'video_list_test.txt'
__C.DATASET.CLIP_LEN = 8
__C.DATASET.CLIP_STRIDE = 4
__C.DATASET.POS_THRES = 0.5
__C.DATASET.NEG_THRES = 0.1
__C.DATASET.ANNOT_JSON_SAVE_PATH = './meva_annot.json'
__C.DATASET.ANNOT_PATH = './'
__C.DATASET.VIDEO_LIST = ''


__C.DATASET.VIDEO_ROOT = ''
__C.DATASET.TRAIN_VIDEO_LIST = ''
__C.DATASET.TRAIN_ANNOT_PATH = ''
__C.DATASET.TEST_VIDEO_LIST = ''
__C.DATASET.TEST_ANNOT_PATH = ''

__C.ANNOT = edict()
__C.ANNOT.TRAIN_DEF_PATH = ""
__C.ANNOT.TEST_DEF_PATH = ""
__C.ANNOT.TRAIN_OUT_PATH = ""
__C.ANNOT.TEST_OUT_PATH = ""
...
__C.TRAIN.NUM_LOGGING_PER_EPOCH = 6.0
__C.TRAIN.WPOS = 0.9
...
__C.TEST.WITH_DENSE_CRF = False
__C.TEST.WITH_MASK = False
